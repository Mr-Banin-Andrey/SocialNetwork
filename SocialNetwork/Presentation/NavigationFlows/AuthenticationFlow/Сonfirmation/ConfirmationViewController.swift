...
//            
//            self.codText.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 0),
//            self.codText.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: 0),
